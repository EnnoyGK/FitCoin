...
@AndroidEntryPoint
class ShopsFragment: Fragment(R.layout.catalog_sport) {
   ...
   // private lateinit var shopsAdapter: ShopsAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       when{
        ...
        cv_sportmaster.setOnClickListener(){
            findNavController().navigate(R.id.action_shopsFragment_to_sportMasterFragment)
        }
