...
@AndroidEntryPoint
class ShopsFoodFragment: Fragment(R.layout.catalog_food) {
   ...
   // private lateinit var shopsAdapter: ShopsAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       when{
        ...
        cv_likefood.setOnClickListener(){
            findNavController().navigate(R.id.action_shopsFoodFragment_to_likeFoodFragment)
        }
